...
>|`14`<br/> {::nomarkdown}<ul><li>Printing a Poster</li></ul>{:/} |`15`<br/> {::nomarkdown}<ul><li>Printing a Poster</li></ul>{:/} |`16`<br/>      |`17`<br/> {::nomarkdown}<ul><li>Sharing Posters</li></ul>{:/} |`18`<br/>      |`19`<br/>      |`20` {::nomarkdown}<ul><li>Picking Trash</li></ul>{:/}|
...
> #### `9`
> <br/>
><a name="2019-4-9-Poster"></a>
>![2019-4-9-Poster]({{ site.url }}/assets/images/Posts/IndividualsCanMakeADifference/2019-4-9-Poster.jpg){:style="margin-right: 7px; margin-top: 7px; margin-bottom: auto; height: 250px; width: auto;"}
> <br/>
