...
![FineDust]({{ site.url }}/assets/images/Posts/AboutTheAirPollution/FineDust.jpg =480x){:style="float: left;margin-right: 7px; margin-top: 7px;"}
...
![NitrogenDioxide]({{ site.url }}/assets/images/Posts/AboutTheAirPollution/NitrogenDioxide.jpg =480x){:style="float: left;margin-right: 7px; margin-top: 7px;"}
