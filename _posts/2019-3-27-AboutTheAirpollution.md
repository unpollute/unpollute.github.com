...
![FineDust]({{ site.url }}/assets/images/Posts/AboutTheAirPollution/FineDust.jpg){:height="250px" :style="float: left;margin-right: 7px; margin-top: 7px;"}
...
![NitrogenDioxide]({{ site.url }}/assets/images/Posts/AboutTheAirPollution/NitrogenDioxide.jpg){:height="250px" :style="float: left;margin-right: 7px; margin-top: 7px;"}
