...
![FineDust]({{ site.url }}/assets/images/Posts/AboutTheAirPollution/FineDust.jpg =250x){:style="float: left;margin-right: 7px; margin-top: 7px;"}
...
![NitrogenDioxide]({{ site.url }}/assets/images/Posts/AboutTheAirPollution/NitrogenDioxide.jpg =250x){:style="float: left;margin-right: 7px; margin-top: 7px;"}
