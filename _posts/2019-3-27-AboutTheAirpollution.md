...
![FineDust alt <]({{ site.url }}/assets/images/Posts/AboutTheAirPollution/FineDust.jpg){:style="float: left;margin-left: 7px;margin-top: 7px;"}
...
![NitrogenDioxide alt <]({{ site.url }}/assets/images/Posts/AboutTheAirPollution/NitrogenDioxide.jpg){:style="float: left;margin-left: 7px;margin-top: 7px;"}
